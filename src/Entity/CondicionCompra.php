...
/**
 * @ORM\Entity(repositoryClass=CondicionCompraRepository::class)
 */
class CondicionCompra
{
    ...
    /**
     * @Assert\Regex(pattern="/^[a-zA-ZñÁÉÍÓÚáéíó ú]+$/", message = "Insertar solo letras en el campo Condición de compra.")
