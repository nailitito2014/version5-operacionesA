...
/**
 * @ORM\Entity(repositoryClass=ViaRecepcionRepository::class)
 */
class ViaRecepcion
{
    /**
    ...
    /**
     * @Assert\Regex(pattern="/^[a-zA-ZñÁÉÍÓÚáéíó ú]+$/", message = "Insertar solo letras en el campo Vía de recepción.")
